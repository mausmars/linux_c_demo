...
static const char *LOG_LEVELS[] = {LOG_PREFIX_ERROR, LOG_PREFIX_WARNING, LOG_PREFIX_STATUS, LOG_PREFIX_DEBUG};
...
void print_to_file(const int level, const char *message) {
    ...
    int res = fprintf(log_global_set.out_file, "%s: %02i:%02i:%02i [%s] %s\n", PROGRAM_NAME,
